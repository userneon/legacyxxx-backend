...
CREATE TABLE IF NOT EXISTS legacy_x.staff_panel_actions (
  ...
  action_type text NOT NULL CHECK (action_type IN ('ban','kick','mute','rename','map_change','server_announcement','match_announcement','hud_announcement','player_message','restart_all','restart_server','start_server','stop_server','timeout','player_ip_lookup')),
...
ALTER TABLE legacy_x.staff_panel_actions ADD CONSTRAINT staff_panel_actions_action_type_check CHECK (action_type IN ('ban','kick','mute','rename','map_change','server_announcement','match_announcement','hud_announcement','player_message','restart_all','restart_server','start_server','stop_server','timeout','player_ip_lookup'));
